...
#else
  ladios(ELogVerbosity::Error) << "ADIOS2 not available - compile with ADIOS2 support" << std::endl;
#endif
}
...
#else
  ladios(ELogVerbosity::Error) << "ADIOS2 not available" << std::endl;
